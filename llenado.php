        ...
        try {
            ...
            $formData = [
                ...
                "eventData" => [
                    ...
                    "url_params" => (object)[],
                    "page" => [
                        "url" => "https://api.leadconnectorhq.com/widget/form/ijaNwi1qbCdBT5XUT41z",
                        "title" => ""
                    ],
                    ...
                    "fbc" => "",
                    "type" => "page-visit",
                    "parentId" => "ijaNwi1qbCdBT5XUT41z",
                    "pageVisitType" => "form",
                    "domain" => "api.leadconnectorhq.com",
                    "version" => "v3",
                    "parentName" => "Auto Test",
                    "fingerprint" => null,
                    "documentURL" => "https://api.leadconnectorhq.com/widget/form/ijaNwi1qbCdBT5XUT41z",
                    "gaClientId" => "GA1.1.2075312899.1762448517",
                    "fbEventId" => uniqid(),
                    "medium" => "form",
                    "mediumId" => "ijaNwi1qbCdBT5XUT41z"
                ],
                "sessionFingerprint" => uniqid(),
                "Timezone" => "America/Caracas (GMT-04:00)",
                "paymentContactId" => (object)[],
                "timeSpent" => 26.096
            ];

            // convertir el objeto interno a JSON
            $postFields = [
                "formData" => json_encode($formData),
                "locationId" => "Ae9CWqvLhRrWhbtnbr9Q",
                "formId" => "ijaNwi1qbCdBT5XUT41z",
                "captchaV3" => "" // obligatorio aunque vacío
            ];

            $ch = curl_init($ghlUrl);
            curl_setopt($ch, CURLOPT_POST, true);
            curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query($postFields)); // <--- forma correcta
            ...
            // registrar log
            file_put_contents(__DIR__ . "/ghl_log.txt", date('Y-m-d H:i:s') . " [$httpCode] $response" . PHP_EOL, FILE_APPEND);
